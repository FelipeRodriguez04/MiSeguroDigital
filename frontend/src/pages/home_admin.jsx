  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-r from-green-100 via-white to-green-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-6">
        <div className="max-w-2xl w-full bg-white/80 rounded-2xl shadow-xl p-10 backdrop-blur-sm text-center">
          <h1 className="text-5xl font-extrabold text-green-700 mb-4">
            Bienvenido,<br /> Administrador del Broker
          </h1>
          <p className="text-gray-700 text-lg mb-8">
            Administra pólizas, requisitos, versiones y supervisa solicitudes de tus analistas.
          </p>

          <div className="flex justify-center mb-8">
            <img src="https://cdn-icons-png.flaticon.com/512/9428/9428855.png" alt="Administrador" className="w-28 h-28" />
          </div>

          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/broker/policies"
            ...
            <Link to="/broker/requirements"
              className="inline-block no-underline border-2 border-green-600 !text-green-700 visited:!text-green-700 focus:!text-green-700 hover:!text-white hover:!bg-green-600 active:!text-green-800 px-6 py-2 rounded-lg text-base font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
              Requisitos por Póliza
            </Link>
            <Link to="/broker/versions"
              className="inline-block no-underline border-2 border-green-600 !text-green-700 visited:!text-green-700 focus:!text-green-700 hover:!text-white hover:!bg-green-600 active:!text-green-800 px-6 py-2 rounded-lg text-base font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
              Versionamiento
            </Link>
